/* Generated By:JJTree&JavaCC: Do not edit this line. MiniJava.java */
import java.io.*;

class MiniJava/*@bgen(jjtree)*/implements MiniJavaTreeConstants, MiniJavaConstants {/*@bgen(jjtree)*/
  protected JJTMiniJavaState jjtree = new JJTMiniJavaState();
  ...
  final public void ReturnExpression() throws ParseException {
  ...
  final public void NewClassExpression() throws ParseException {
  ...
  final public void NewIntArrayExpression() throws ParseException {
  ...
  final public void NegtiveExpression() throws ParseException {
                                    /*@bgen(jjtree) NegNode */
